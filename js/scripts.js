...
mr = (function (mr, $, window, document) {
  ...
  mr.easypiecharts.documentReady = function ($) {
    $(".radial").each(function () {
      ...
      if (typeof chart.attr("data-size") !== typeof undefined) {
        pieSize = attributeOverrides.size = parseInt(
          chart.attr("data-size"),
          10
        );
      }
      if (typeof chart.attr("data-bar-width") !== typeof undefined) {
        attributeOverrides.lineWidth = parseInt(
          chart.attr("data-bar-width"),
          10
        );
      }
  ...
  mr.easypiecharts.activate = function () {
    mr.easypiecharts.pies.forEach(function (pie) {
      if (
        Math.round(mr.scroll.y + mr.window.height) >=
...
mr = (function (mr, $, window, document) {
  ...
  mr.typed.documentReady = function ($) {
    $(".typed-text").each(function () {
      ...
      ao.strings = text.attr("data-typed-strings")
        ? text.attr("data-typed-strings").split(",")
        : undefined;
